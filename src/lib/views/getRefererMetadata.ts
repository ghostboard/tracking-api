...
export default function (params: any): any {
  ...
  try {
    ...
    if (referer) {
      ...
      const filterVisitSource =
        mustFilter || fromGhostAdminUrl || fromGhostAdminDomain;
    ...
    console.error('>> getRefererMetadata Error Input', params);
    console.error('>> getRefererMetadata Error', e);
  }
  return output;
}
